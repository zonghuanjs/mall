...
@Repository
public class BeanViewDaoImpl extends BaseDaoImpl<Date, BeanView> implements BeanViewDao {
	...
	public List<BeanView> findByPager(Pager<BeanView> pager, Map<String, Object> geFilter,
		...
		if (pager == null) {
			...
			List<BeanView> list = new LinkedList<>();
			try {
				session = this.currentSession();
				DetachedCriteria detachedCriteria = DetachedCriteria.forClass(BeanView.class);
