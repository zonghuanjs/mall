...
public class ProductCategory extends BaseEntity
{
	 ...
	 * 直接子类列表
	 */
	@OneToMany(targetEntity=ProductCategory.class, mappedBy="parent", cascade={CascadeType.PERSIST, CascadeType.MERGE})
	 ...
	 * 关联参数组
	 */
	@OneToMany(targetEntity=ParameterGroup.class, mappedBy="productCategory", cascade={CascadeType.PERSIST, CascadeType.MERGE})
	@OrderBy("orders")
