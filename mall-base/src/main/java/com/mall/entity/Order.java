...
import com.mall.service.ApplyService;
...
public class Order {
	...
	private int orderStatus; // 订单状态: 1,未支付; 2, 已支付; 3, 待发货; 4, 已发货; 0, 交易完成;
								// 5,待处理; 6, 退货处理; -1,交易关闭
	...
	@OneToMany(targetEntity = OrderItem.class, mappedBy = "orders", cascade = { CascadeType.PERSIST,
			CascadeType.MERGE })
	...
	/*
	 * public boolean isInvoice() { return isInvoice; }
	 * 
	 * public void setInvoice(boolean isInvoice) { this.isInvoice = isInvoice; }
	 */
