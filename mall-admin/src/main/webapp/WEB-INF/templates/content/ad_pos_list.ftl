...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 广告位列表 <span>(共<span id="pageTotal">${pager.totalCount?c}</span>条记录)</span>
	</div>
	<form id="listForm" action="" method="get">
		<div class="bar">
			<a href="${base}/admin/adPosition/add.do" class="iconButton">
		...
		<table id="listTable" class="list">
			...
			<#list adPositionList as adPosition>
				<tr>
					...
					<td>
						<a href="${base}/admin/adPosition/edit!${adPosition.id}.do">[编辑]</a>
					</td>
				</tr>
			</#list>	
