...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 快递单模板列表 <span>(共<span id="pageTotal">1</span>条记录)</span>
	</div>
	<form id="listForm" action="${base}/admin/order/deliveryTemplate.do" method="get">
		<div class="bar">
			<a href="${base}/admin/order/deliveryTemplateAdd.do" class="iconButton">
