...
<body>
	...
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 品牌列表 <span>(共<span id="pageTotal">${pager.totalCount?c}</span>条记录)</span>
	</div>
	<form id="listForm" action="" method="get">
		<div class="bar">
			<a href="${base}/admin/brand/add.do" class="iconButton">
		...
		<#list brandList as brand>
			<tr>
				...
				<td>
					<a href="${base}/admin/brand/edit.do?id=${brand.id}">[编辑]</a>
				</td>
			</tr>
		</#list>
