...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 添加规格
	</div>
	<form id="inputForm" action="<#if specification??>${base}/admin/specification/save.do?id=${specification.id}<#else>${base}/admin/specification/add.do</#if>" method="post">
