...
<body>
	...
	<form id="inputForm" action="<#if group??>save.do?groupId=${group.id}<#else>add.do</#if>" method="POST">
		...
		<table class="input">
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="返&nbsp;&nbsp;回" onclick="location.href='list.do'"  />
				</td>
			</tr>
		</table>
	</form>
