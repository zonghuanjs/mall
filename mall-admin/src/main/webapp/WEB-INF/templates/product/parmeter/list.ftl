...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 参数列表 <span>(共<span id="pageTotal">${pager.totalCount?c}</span>条记录)</span>
	</div>
	<form id="listForm" action="${base}/admin/parameter/list.do" method="get">
		<div class="bar">
			<a href="${base}/admin/parameter/add.do" class="iconButton">
		...
		<table id="listTable" class="list">
			...
			<#if group??>
				<tr>
					...
					<td>
						<a href="${base}/admin/parameter/edit.do?groupId=${group.id}">[编辑]</a>
					</td>
				</tr>
			</#if>
			</#list>
