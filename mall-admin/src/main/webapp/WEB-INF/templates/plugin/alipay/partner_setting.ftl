...
<title>支付宝担保交易设置 -${config.siteName}</title>
	...
	<#if plugin??>
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="sellerEmail" class="text" value="${plugin.attributes['seller_email']!''}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="key" class="text" value="${plugin.attributes['api_key']!''}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>同步通知地址:
				</th>
				<td>
					<input type="text" name="returnUrl" class="text" value="${plugin.attributes['return_url']!''}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>异步通知地址:
				</th>
				<td>
					<input type="text" name="notifyUrl" class="text" value="${plugin.attributes['notify_url']!''}" maxlength="200" />
				</td>
			</tr>			
			<tr>
				<th>
