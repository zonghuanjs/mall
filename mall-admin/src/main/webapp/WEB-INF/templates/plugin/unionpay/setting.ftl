...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 中国银联在线支付插件设置
	</div>
	...
	<#if plugin??>
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="pubCertNameOther" class="text" style="width:300px;" value="${plugin.attributes['pubCertNameOther']!''}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
