...
<head>
<meta charset="UTF-8">
<title>订单处理通知-${config.siteName}</title>
...
<body>
	<div class="main">
        ...
        <div class="content">
	        <h4>尊敬的订单管理员您好：</h4>
            <p>${config.siteName}（<a href="${config.siteUrl}/admin/" target="_blank" >${config.siteUrl}</a>有一笔订单需要处理, 请登录${config.siteName}后台管理系统:</p>
            ...
            <div class="table">
            	<div class="tableTitle">
                	<div class="orderNo leftFloat" style="text-decoration:underline; color:#1D79B6; padding-left:13px;">订单编号：${order.sn}</div>
                ...
                <div class="orderList">
                	<div class="orderItem">
                        ...
                        <div class="consignee leftFloat height" id="nameHeight">${order.consignee}</div>
                        <div class="amount leftFloat height" id="priceHeight">${order.amountPaid?string.currency}</div>
                        <div class="orderTime leftFloat height" id="timeHeight" style="border-right:none;">${order.createDate?datetime}</div>
                        <div class="clear"></div>
                    </div>
