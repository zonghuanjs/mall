...
<head>
<meta charset="UTF-8">
<title>找回密码-${config.siteName}</title>
...
<body>
	<div class="main">
        ...
        <div class="content">
            ...
            <p>我们的系统检测到您正在进行重置密码操作, 请点击下面的验证链接进行密码重置:</p>
            <p><a href="${config.siteUrl}/account/find_password.do?key=${member.tmpKey}" target="_blank">${config.siteUrl}/account/find_password.do?key=${member.tmpKey}</a></p>
