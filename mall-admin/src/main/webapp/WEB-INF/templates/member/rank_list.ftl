...
<body>
	<div class="path">
		<a href="${base}/admin/index.do">首页</a> &raquo; 会员等级列表 <span>(共<span id="pageTotal">${pager.totalCount?c}</span>条记录)</span>
	</div>
	<form id="listForm" action="${base}/admin/memberRank/list.do" method="get">
		<div class="bar">
			<a href="${base}/admin/memberRank/add.do" class="iconButton">
