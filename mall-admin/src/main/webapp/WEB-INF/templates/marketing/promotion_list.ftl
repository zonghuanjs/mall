...
<body>
	<div class="path">
		<a href="${base}/admin/home.do">首页</a> &raquo; 促销列表 <span>(共<span id="pageTotal">${pager.totalCount?c}</span>条记录)</span>
	</div>
	<form id="listForm" action="" method="get">
		<div class="bar">
			<a href="${base}/admin/promotion/add.do" class="iconButton">
		...
		<table id="listTable" class="list">
			...
			<#list promotions as promotion>
				<tr>
					...
					<td>
						<span title="限时抢购">${promotion.name}</span>
					</td>
					<td>
						<span title="限时抢购">${promotion.title}</span>
					</td>
					<td>
							<span title="${promotion.beginDate}">${promotion.beginDate}</span>
					</td>
					<td>
							<span title="${promotion.endDate}">${promotion.endDate}</span>
					</td>
					<td>
						${promotion.orders}
					</td>
					<td>
						<a href="${base}/admin/promotion/edit!${promotion.id}.do">[编辑]</a>
						<a href="${base}/promotion/promotion-${promotion.id}.do" target="_blank">[查看]</a>
					</td>
				</tr>
			</#list>	
		</table>
